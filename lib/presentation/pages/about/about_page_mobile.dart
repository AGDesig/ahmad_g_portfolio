...
import 'package:agportfolio/presentation/pages/about/about_page.dart';
import 'package:agportfolio/presentation/widgets/app_drawer.dart';
import 'package:agportfolio/presentation/widgets/bottom_draggable_scrollable_sheet.dart';
...
import 'package:agportfolio/presentation/widgets/flicker_text_animation.dart';
  ...
  Widget _fadeInContent() {
    ...
    return AnimatedBuilder(
      ...
      child: Text(
        ...
        style: theme.textTheme.bodyLarge!.copyWith(color: AppColors.black,fontSize:Sizes.TEXT_SIZE_18 ),
      ),
      builder: (BuildContext context, Widget? child) {
